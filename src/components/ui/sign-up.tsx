...
const IntelligenceCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Soft breathing radial volumetric glow
      ...
      connections.forEach((conn) => {
        ...
        const baseAlpha = 0.05 + ((avgZ + 1.0) / 2.0) * 0.08;
        ctx.beginPath();
      ...
      <section className="flex-1 flex items-center justify-center px-8 py-16 md:px-20 relative z-10 bg-black">
        <div className="w-full max-w-[390px] flex flex-col justify-between h-full max-h-[660px]">
          ...
          <div className="my-auto py-6">
            <div className="mb-6">
              <h1 className="text-[34px] font-light text-white tracking-tight leading-[1.15] mb-3 animate-element animate-delay-200">
                Deploy with<br />
              ...
              <p className="text-[13px] text-white/40 leading-relaxed font-light tracking-wide animate-element animate-delay-300">
                Create a free account to launch autonomous workflows and claim 10,000 free inference credits.
              </p>
            </div>

            <form className="space-y-3.5 animate-element animate-delay-400" onSubmit={onSignUp}>
              {/* Full Name */}
              <div className="space-y-1.5">
                ...
                <div
                  ...
                  style={{
                    background: focusedField === 'name' ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.01)',
                    border: focusedField === 'name' ? '1px solid rgba(255,255,255,0.22)' : '1px solid rgba(255,255,255,0.07)',
                    boxShadow: focusedField === 'name' ? '0 0 16px rgba(255,255,255,0.06)' : 'none',
                  }}
                >
                  <input
                    name="name"
              ...
              <div className="space-y-1.5">
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: focusedField === 'password' ? '0 0 16px rgba(255,255,255,0.06)' : 'none',
                  }}
                >
                  <input
                    name="password"
                    ...
                    onBlur={() => setFocusedField(null)}
                    placeholder="••••••••••••"
                    className="w-full bg-transparent text-[13px] px-5 py-3 pr-12 rounded-full focus:outline-none text-white placeholder:text-white/20 font-light"
                  />
                  <button
                    type="button"
              ...
              <div className="pt-1.5">
                <button
                  type="submit"
                  className="w-full rounded-full py-3 text-[13px] font-semibold tracking-wide transition-all duration-300 cursor-pointer text-black bg-white hover:bg-zinc-100 hover:scale-[1.01]"
                  style={{
            ...
            {/* Divider */}
            <div className="relative flex items-center justify-center my-5 animate-element animate-delay-500">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 rounded-full py-3 text-[13px] font-medium text-white/70 hover:text-white transition-all duration-300 cursor-pointer border border-white/[0.08] hover:border-white/[0.18] hover:bg-white/[0.02] animate-element animate-delay-600"
              style={{
