  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      content: "Decluttering my mind with Bloomport has been a game-changer. The AI mindfulness sessions are so incredibly calming! 🧘‍♀️✨",
      date: "May 25, 2026",
      verified: true,
      likes: 182,
      retweets: 24,
    ...
    },
    {
      ...
      handle: "@marcus_mindful",
      content: "The hover transitions on the new Bloomport feature section are so smooth. Loving how they make building focus habits fun. Great UX!",
      date: "May 24, 2026",
      verified: true,
      likes: 94,
      retweets: 12,
    ...
    },
    {
      ...
      content: "Finally, a productivity app that values silence and focus over constant notifications. The dark glassmorphic design is absolutely gorgeous. 🌌",
      date: "May 23, 2026",
      verified: true,
      likes: 312,
      retweets: 48,
