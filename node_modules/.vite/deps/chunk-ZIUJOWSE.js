...
var ICONS = {
  add: async () => (await import("./add-NTLFKFIV.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-HT5BLAUS.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-YR6G4V3C.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-2WH5TSAU.js")).appStoreSvg,
  apple: async () => (await import("./apple-IY3EC7EQ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-WCVZSM4Z.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BIZULCGW.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-3O3XACJX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-MVLXZ4MW.js")).arrowTopSvg,
  bank: async () => (await import("./bank-2ZZ2LUW6.js")).bankSvg,
  browser: async () => (await import("./browser-FDZ3TW3R.js")).browserSvg,
  card: async () => (await import("./card-OCPHKFIU.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-YGT3BOPD.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-XO7OGZ42.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-DUT3P3TZ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-6IUQLTGP.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-6UGGD4V7.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-YCCQKHJJ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-BTAHT5DT.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-EWALOAJK.js")).clockSvg,
  close: async () => (await import("./close-JWFAUTA2.js")).closeSvg,
  compass: async () => (await import("./compass-S27EWNK2.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-47A7ZGCZ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-HKPT52FG.js")).copySvg,
  cursor: async () => (await import("./cursor-6LC3V33S.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-6YLIJALG.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-T5F24OJA.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-GJYBT2ZB.js")).disconnectSvg,
  discord: async () => (await import("./discord-3YDRDJRJ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-TU56AK2M.js")).etherscanSvg,
  extension: async () => (await import("./extension-6XJTA5TO.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-PERCGELE.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-PWRI22BF.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-UHIN62X4.js")).farcasterSvg,
  filters: async () => (await import("./filters-NBXTCSOI.js")).filtersSvg,
  github: async () => (await import("./github-QCNI4NO7.js")).githubSvg,
  google: async () => (await import("./google-MPMWZDH2.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-YKKDI4GY.js")).helpCircleSvg,
  image: async () => (await import("./image-Z6MTH7QQ.js")).imageSvg,
  id: async () => (await import("./id-SJEL6UCT.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-FOWZBSIE.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-HGIO34FH.js")).lightbulbSvg,
  mail: async () => (await import("./mail-AQ7HCL75.js")).mailSvg,
  mobile: async () => (await import("./mobile-UJ4V5T26.js")).mobileSvg,
  more: async () => (await import("./more-UXLFMR4M.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-QRFE36IZ.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-C65KJQ76.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-E34MGEPD.js")).offSvg,
  playStore: async () => (await import("./play-store-SHLR5APA.js")).playStoreSvg,
  plus: async () => (await import("./plus-7BJREJB3.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-45DN3XA7.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-PZL2P5TQ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-PSXAJ6Q3.js")).refreshSvg,
  search: async () => (await import("./search-KBLIVQPB.js")).searchSvg,
  send: async () => (await import("./send-H22I4GDP.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RM3LKTCL.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-B552TLIG.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-VBFEAX2M.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-K7QQB7R5.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-NKIH7KMW.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-RCGMUUYH.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-QEOOA6QB.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-Q53ZS3CU.js")).twitchSvg,
  twitter: async () => (await import("./x-YGIECWTX.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-5E7CDDJO.js")).twitterIconSvg,
  verify: async () => (await import("./verify-7UPQZZOX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-NULMSR4J.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-TS24Y55N.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ZHN35URB.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ZHN35URB.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ZHN35URB.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-LK3GPTLR.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-DYGCSD35.js")).warningCircleSvg,
  x: async () => (await import("./x-YGIECWTX.js")).xSvg,
  info: async () => (await import("./info-4TJ7L47L.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-VGUJZHMA.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-FDAHPDJ3.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZIUJOWSE.js.map
