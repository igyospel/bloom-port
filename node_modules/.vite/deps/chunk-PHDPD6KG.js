...
async function getTransactionCount2(client, { address, blockHash, blockNumber, blockTag = "latest", requireCanonical }) {
...
async function wait2(time, { signal } = {}) {
  return new Promise((resolve, reject) => {
    ...
    if ((account == null ? void 0 : account.type) === "local") {
      if (account.nonceManager && typeof nonce === "undefined") {
        ...
        const chainId = await (async () => {
          ...
          if (chain)
            return chain.id;
          return getAction2(client, getChainId2, "getChainId")({});
        })();
...
function withRetry2(fn3, { delay: delay_ = 100, retryCount = 2, shouldRetry: shouldRetry2 = () => true, signal } = {}) {
  return new Promise((resolve, reject) => {
...
async function getCode2(client, { address, blockHash, blockNumber, blockTag = "latest", requireCanonical }) {
  const block = formatBlockParameter({
    blockHash,
    blockNumber,
    blockTag,
...
function verify(options) {
  ...
  if (options.address)
    return isEqual(options.address, recoverAddress3({ payload, signature: options.signature }));
  return secp256k13.verify(options.signature, from(payload), toBytes3(options.publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-PHDPD6KG.js.map
